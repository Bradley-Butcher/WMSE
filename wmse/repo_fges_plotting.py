...
def plot(results: pd.DataFrame, name: str):
    ...
    fig.suptitle(f'FGES Performance on {name} BN.')
...
# %%
## ALARM
a_df = pd.read_csv(result_path / "alarm_experiments_small.csv")
...
# %%
# CHILD
c_df = pd.read_csv(result_path / "insurance_large.csv")

plot(c_df, "CHILD")
# %%
a_df = pd.read_csv(result_path / "alarm_fges_small.csv")

plot(a_df, "ALARM (100-1000 Samples)")
